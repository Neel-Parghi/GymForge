...
namespace GymForge.Infrastructure.Migrations
{
    ...
    [Migration("20260420112259_AddSaaSPaymentTransaction")]
    partial class AddSaaSPaymentTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymForge.Domain.Entities.SaaSPaymentTransaction", b =>
                {
                    ...
                    b.HasOne("GymForge.Domain.Entities.GymSubscription", "Subscription")
                        .WithMany()
